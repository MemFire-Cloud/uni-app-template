        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if ('code' in credentials) {
                    ...
                    res = yield (0, fetch_1._request)(this.fetch, 'GET', `${this.url}/wechat_mini/login?code=${code}`, {
    ...
    wechatBindPhone(credentials) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if ('code' in credentials) {
                    const { code } = credentials;
                    const { data, error: userError } = yield (0, fetch_1._request)(this.fetch, 'GET', `${this.url}/wechat_mini/bind_phone?code=${code}`, {
                        headers: this.headers,
    ...
    wechatBindAccount(credentials) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if ('code' in credentials) {
                    const { code } = credentials;
                    const { data, error: userError } = yield (0, fetch_1._request)(this.fetch, 'GET', `${this.url}/wechat_mini/bind_account?code=${code}`, {
                        headers: this.headers,
                        jwt: session.access_token,
                        xform: fetch_1._userResponse,
                    });
    ...
    getUnlimitedQRCode(credentials) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                res = yield (0, fetch_1._request)(this.fetch, 'POST', `${this.url}/wechat_mini/unlimited_qrcode`, {
                    headers: this.headers,
