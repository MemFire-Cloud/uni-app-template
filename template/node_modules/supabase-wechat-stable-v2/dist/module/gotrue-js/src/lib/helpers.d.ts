...
export declare const setItemAsync: (storage: SupportedStorage, key: string, data: any) => void;
export declare const getItemAsync: (storage: SupportedStorage, key: string, data: any) => any;
