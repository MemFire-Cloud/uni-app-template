...
import type { AuthChangeEvent, AuthResponse, CallRefreshTokenResult, GoTrueClientOptions, InitializeResult, OAuthResponse, SSOResponse, Session, SignInWithOAuthCredentials, SignInWithPasswordCredentials, SignInWithPasswordlessCredentials, SignInWithSSO, WechatBindPhoneCredentials, WechatBindAccountCredentials, unlimitedQRCodeCredentials, SignUpWithPasswordCredentials, SignInWithWechatCredentials, Subscription, SupportedStorage, User, UserAttributes, UserResponse, VerifyOtpParams, GoTrueMFAApi } from './lib/types';
export default class GoTrueClient {
     ...
     *
     */
    signInWithWechat(credentials: SignInWithWechatCredentials): Promise<AuthResponse>;
    /**
     * wechat get phone
     *
     */
    wechatBindPhone(credentials: WechatBindPhoneCredentials): Promise<{
        data: {
            user: User;
        };
        error: null;
     ...
     *
     */
    wechatBindAccount(credentials: WechatBindAccountCredentials): Promise<{
        data: {
            user: User;
        };
        error: null;
     ...
     *
     */
    getUnlimitedQRCode(credentials: unlimitedQRCodeCredentials): Promise<{
        data: {
            imgBase64: null;
        };
        error: any;
