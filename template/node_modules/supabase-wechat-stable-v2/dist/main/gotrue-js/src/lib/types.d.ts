...
export declare type unlimitedQRCodeCredentials = {
...
export declare type WechatBindPhoneCredentials = {
    /** The wechat bindphone code */
    code: string;
};
export declare type WechatBindAccountCredentials = {
    /** The wechat BindAccount code. */
    code: string;
};
export declare type SignInWithWechatCredentials = {
    /** The wechat login code. */
    code: string;
};
